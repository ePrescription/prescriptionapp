...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>Doctor Prescriptions List</h1>
            <ol class="breadcrumb">
                <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>

                <li class="active">Doctor Prescriptions List</li>
            </ol>
                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title" style="line-height:30px;width:500px;float:left;">Doctor Prescriptions Details List</h3>
                            <!--
                            ...
                            -->
                            <form action="{{URL::to('/')}}/doctor/rest/api/prescription" method="get" style="line-height:30px;width:500px;float:left;">
                                <div class="col-xs-3">
                                Search By PRID
                                </div>
                                <div class="col-xs-5">
