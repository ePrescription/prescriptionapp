            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <a href="" style="float: right;margin-right:10px;" ><button type="button" class="btn btn-success btn-xs" onclick="javascript:printDiv();"><i class="fa fa-print"></i> PRINT</button></a>

                        <a href="#" style="float: right;margin-right:10px;" id="showModalSMS" class="btn btn-success  btn-xs"><i class="fa fa-mobile"></i> SMS</a>

                        <a href="#" style="float: right;margin-right:10px;" id="showModalEMAIL" class="btn btn-success  btn-xs"><i class="fa fa-envelope-o"></i> E-MAIL</a>
                    </div>
                </div>
            </div>
<!--
