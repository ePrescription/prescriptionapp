 ...
 * @category Numbers
 * @package  Numbers_Words
 * @author   Abhinav Nayak <abhinav@nayakweb.in>
 * @license  PHP 3.01 http://www.php.net/license/3_01.txt
 * @link     http://pear.php.net/package/Numbers_Words
 */
class Numbers_Words_Locale_en_IN extends Numbers_Words
{
    ...
    var $_currency_names = array(
      ...
      'INR' => array(array('Indian Rupees', 'Indian Rupees'), array('Paise', 'Paise')),
      ...
      'ZAR' => array(array('rand'), array('cent')),
        //'INR' => array(array('rupee'), array('paise', 'paise'))
    );
     ...
     * @access public
     */
    var $def_currency = 'INR'; // Indian Rupee
